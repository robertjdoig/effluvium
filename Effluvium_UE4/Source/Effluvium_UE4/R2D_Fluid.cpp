...
// Called every frame
void AR2D_Fluid::Tick(float DeltaTime)
{
...
void AR2D_Fluid::set_boundary(int N, int b, float * x)
{
...
void AR2D_Fluid::gauss_siedel(int N, int b, float * x, float * x0, float a, float c)
{
...
void AR2D_Fluid::diffuse(int N, int b, float * x, float * x0, float diff, float dt)
{
  float a = dt * diff * (N * N);
  gauss_siedel(N, b, x, x0, a, 1 + 4 * a);
}

void AR2D_Fluid::advect(int N, int b, float * d, float * d0, float * u, float * v, float dt)
{
...
void AR2D_Fluid::project(int N, float * u, float * v, float * p, float * div)
{
...
void AR2D_Fluid::density_step(int N, float * x, float * x0, float * u, float * v, float diff, float dt)
{
...
void AR2D_Fluid::velocity_step(int N, float * u, float * v, float * u0, float * v0, float visc, float dt)
{
...
int AR2D_Fluid::IX(int i, int j, int N) {
  return ((i)+(N + 2) * (j));
}